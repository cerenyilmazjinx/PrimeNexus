...
#[derive(Debug)]
pub struct PrimeNexusProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PrimeNexusProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PrimeNexus processing");
    
    let mut processor = PrimeNexusProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PrimeNexusProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PrimeNexusProcessor::new(false);
